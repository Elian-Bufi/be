...
const DEFINIDAS: readonly Operacion[] = [
  ...
  },
  {
    ...
    errores: {
      ...ESCRITURA_REVELABLE,
      409: ['IDEMPOTENCY_KEY_REUSED'],
      422: ['EXECUTION_DRAFT_NOT_READY', 'EXECUTION_GRANULARITY_INVALID', 'SESSION_CONDITION_INVALID', 'EXECUTION_VALUE_INVALID', 'EXERCISE_REFERENCE_INVALID', 'CORRECTION_NOT_ALLOWED'],
    },
