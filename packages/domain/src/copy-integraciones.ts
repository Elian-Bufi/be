...
export const COPY_INTEGRACIONES = {
  ...
  ayudaNumeroDeWger: 'Figura en la dirección de cada ejercicio en wger.de, por ejemplo «/exercise/345/».',
  consultar: 'Consultar',
  ...
  noResoluble: 'Este candidato ya no se puede resolver. Si lo necesitás, consultá el proveedor de nuevo.',
