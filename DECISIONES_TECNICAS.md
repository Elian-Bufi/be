...
| Permanencia del APK | Copia durable en un release de GitHub, además del artefacto de EAS | **El artefacto de EAS expira el 2026-10-01 19:02 UTC**, el mismo día de la entrega. El release `be-apk-0.1.0` conserva el mismo archivo (SHA-256 verificable). Si el repositorio sigue privado, esa URL exige sesión: hay que hacerlo público antes de la entrega, o volver a construir el APK sobre la fecha de defensa. |
